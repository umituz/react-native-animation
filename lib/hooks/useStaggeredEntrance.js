 ...
 */
export const useStaggeredEntrance = (options = {}) => {
    const { delay = 100, duration = 600, translateYOffset = 30, enabled = true, } = options;
    // Animation values
...
//# sourceMappingURL=useStaggeredEntrance.js.map