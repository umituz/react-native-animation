 ...
 * @template T - Type of navigation parameters for the screen
 */
export interface TabScreen<T extends ParamListBase = ParamListBase> extends BaseScreen<T> {
    ...
    options?: BottomTabNavigationOptions | ((props: BottomTabScreenProps<T>) => BottomTabNavigationOptions);
 ...
 * @template T - Type of navigation parameters for the screen
 */
export interface StackScreen<T extends ParamListBase = ParamListBase> extends BaseScreen<T> {
...
export interface TabNavigatorConfig<T extends ParamListBase = ParamListBase> extends BaseNavigatorConfig<T> {
    screens: TabScreen[];
    /** Custom icon renderer function */
    renderIcon?: (iconName: IconName, focused: boolean, routeName: string, isFab: boolean) => React.ReactElement;
    /** Get icon name for a tab */
    getTabIcon?: (routeName: string, focused: boolean) => IconName;
    /** Screen options for all tabs */
    screenOptions?: BottomTabNavigationOptions | ((props: BottomTabScreenProps<T>) => BottomTabNavigationOptions);
    /** FAB configuration for center button styling */
    fabConfig?: FabConfig;
}
export interface StackNavigatorConfig<T extends ParamListBase = ParamListBase> extends BaseNavigatorConfig<T> {
    screens: StackScreen[];
...
export declare const DEFAULT_FAB_CONFIG: Required<FabConfig>;
