 ...
 */
export type SwipeActionType = 'delete' | 'archive' | 'edit' | 'share' | 'favorite' | 'more' | 'custom';
/**
 ...
 */
export declare const DEFAULT_SWIPE_CONFIG: Required<Omit<SwipeableConfig, 'leftActions' | 'rightActions'>>;
export { ACTION_PRESETS, getPreset, getActionLabel, getActionIcon, getActionColorKey, getHapticsIntensity, } from '../utils/swipeActionHelpers';
export { validateSwipeAction, validateSwipeActions, getValidationError, } from '../utils/swipeActionValidator';
