 ...
 */
export declare const BASE_TOKENS: BaseTokens;
export { spacing, typography, borders, iconSizes, opacity, avatarSizes, sizes };
export type { BaseTokens, Spacing, Typography, Borders, IconSizes, Opacity, AvatarSizes, ComponentSizes } from './tokens/BaseTokens';
