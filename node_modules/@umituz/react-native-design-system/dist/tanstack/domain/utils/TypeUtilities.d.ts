 ...
 * ```
 */
export type ExtractQueryDataType<TQuery extends UseQueryResult<unknown, unknown>> = TQuery extends UseQueryResult<infer TData, unknown> ? TData : never;
/**
 ...
 * ```
 */
export type ExtractQueryErrorType<TQuery extends UseQueryResult<unknown, unknown>> = TQuery extends UseQueryResult<unknown, infer TError> ? TError : never;
/**
 ...
 * ```
 */
export type ExtractMutationDataType<TMutation extends UseMutationResult<unknown, unknown, unknown>> = TMutation extends UseMutationResult<infer TData, unknown, unknown> ? TData : never;
/**
 ...
 * ```
 */
export type ExtractMutationErrorType<TMutation extends UseMutationResult<unknown, unknown, unknown>> = TMutation extends UseMutationResult<unknown, infer TError, unknown> ? TError : never;
/**
 ...
 * ```
 */
export type ExtractMutationVariables<TMutation extends UseMutationResult<unknown, unknown, unknown>> = TMutation extends UseMutationResult<unknown, unknown, infer TVariables> ? TVariables : never;
/**
 ...
 * ```
 */
export type ExtractInfiniteDataType<TQuery extends UseQueryResult<unknown, unknown>> = TQuery extends UseQueryResult<infer TData, unknown> ? TData : never;
/**
...
} ? TPages extends Array<infer TPage> ? TPage : never : never;
/**
