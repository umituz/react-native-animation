 ...
 * - Type-safe utilities
 */
export type { InfiniteScrollConfig, PaginatedResult, PageBasedConfig, CursorBasedConfig, } from "./domain/types/infinite-scroll-config";
...
export { isPageBasedConfig, isCursorBasedConfig, isError, isNonNullObject, hasItems, isNonEmptyString, } from "./domain/utils/type-guards";
...
export type { EmptyProps, ErrorProps, LoadingProps, LoadingMoreProps, } from "./presentation/components/types";
