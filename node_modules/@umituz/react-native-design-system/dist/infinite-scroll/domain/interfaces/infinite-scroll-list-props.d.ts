...
export interface InfiniteScrollListProps<T> {
     ...
     */
    flatListProps?: Omit<React.ComponentProps<typeof import("react-native").FlatList<T>>, "data" | "renderItem" | "keyExtractor" | "onEndReached" | "onEndReachedThreshold" | "onRefresh" | "refreshing" | "ListHeaderComponent" | "ListFooterComponent">;
}
